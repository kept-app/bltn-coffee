...
export const metadata: Metadata = {
  ...
  description: "A small neighborhood cafe on the quiet end of Haven Street. Coffee, all-day breakfast, pet-friendly outdoor seating in Causeway Bay.",
};
    ...
    <header className="border-b border-sand-200/80">
      <nav className="mx-auto max-w-5xl flex items-center justify-between px-5 py-5 sm:py-6">
        <Link href="/" className="font-display text-xl tracking-tight text-ink-900">
          bltn<span className="italic-display text-accent-brick">.</span>
        </Link>
        <ul className="flex items-center gap-6 sm:gap-8 text-sm text-ink-700">
          ...
          <li><a href="https://instagram.com/bltncoffee.hk" target="_blank" rel="noopener noreferrer" className="hover:text-ink-900 transition-colors">instagram</a></li>
        </ul>
      </nav>
    </header>
  );
    ...
    <footer className="border-t border-sand-200/80 mt-20">
      <div className="mx-auto max-w-5xl px-5 py-10 grid gap-8 sm:grid-cols-3 text-sm text-ink-700">
        ...
        <div>
          ...
          <a href="https://instagram.com/bltncoffee.hk" target="_blank" rel="noopener noreferrer" className="mt-1 inline-block underline decoration-sand-300 underline-offset-4 hover:decoration-accent-brick">@bltncoffee.hk</a>
        </div>
      </div>
